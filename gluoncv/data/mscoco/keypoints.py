...
class COCOBoxedkeypoints(COCOKeyPoints):
    """COCO keypoint detection dataset with bounding boxes.
    ...
    def __init__(self, root=os.path.join('~', '.mxnet', 'datasets', 'coco'),
                 splits=('person_keypoints_val2017',), aspect_ratio=1.0, skip_empty=True):
        super(COCOBoxedkeypoints, self).__init__(
            root=root, splits=splits, aspect_ratio=aspect_ratio, skip_empty=skip_empty)
